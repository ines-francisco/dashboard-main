...
#valueBox - cria uma caixa no site, objecto, icon ir buscar a imagem que se quer e a cor
```
...
#mybins - cada uma das categorias; mycolors - cores para cada uma das categorias; 
...
#mytext - texto que queresmos que apareça; <br/> - break para aparecer noutra linha
